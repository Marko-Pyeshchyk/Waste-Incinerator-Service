 ...
 * ===========================================================================
 */
public class IncineratorSystem_test {
	...
	Thread th = new Thread(){
		public void run(){
			try {
				...
				CommUtils.outred("TestIncineratorCtx activate ERROR " + e.getMessage());
			}
		}
	};
	th.start();
