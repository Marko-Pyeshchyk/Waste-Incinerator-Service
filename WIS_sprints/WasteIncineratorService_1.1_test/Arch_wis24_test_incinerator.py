...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     test_observer >> Edge(color='blue', style='solid',  decorate='true', label='<burn_start &nbsp; >',  fontcolor='blue') >> incinerator
     incinerator >> Edge(color='blue', style='solid',  decorate='true', label='<state &nbsp; >',  fontcolor='blue') >> test_observer
