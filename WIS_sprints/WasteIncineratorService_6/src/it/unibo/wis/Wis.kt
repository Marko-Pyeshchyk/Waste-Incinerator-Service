	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("ready") { //this:State
					...
					transition(edgeName="t129",targetState="handle_rp_number",cond=whenDispatch("rp_number"))
				...
				state("activated") { //this:State
					...
					transition(edgeName="t132",targetState="handle_rp_number",cond=whenDispatch("rp_number"))
