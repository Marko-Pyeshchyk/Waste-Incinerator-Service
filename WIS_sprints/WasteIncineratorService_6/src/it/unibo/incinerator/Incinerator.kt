		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t124",targetState="activated",cond=whenDispatch("activation_command"))
				}	 
				state("activated") { //this:State
					action { //it:State
						forward("activation_command", "activation_command(N)" ,"wis" ) 
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					sysaction { //it:State
				...
				state("ready") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t125",targetState="burning",cond=whenDispatch("burn_start"))
				}	 
				state("burning") { //this:State
					action { //it:State
						CommUtils.outred("$name	burning...")
						delay(BTIME)
						CommUtils.outred("$name	burn end")
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t126",targetState="ready",cond=whenDispatch("ash_taken"))
				}	 
			}
		}
} 
