 ...
 */
	...
	public void TestSystem() {
		IApplMessage req  = CommUtils.buildRequest( "tester", "test_request", "test_request(1)", "test_observer");
 		try {
			...
			assertTrue(answer.indexOf("moving_to_WASTEIN") < answer.indexOf("moving_to_BURNIN"));
			assertTrue(answer.indexOf("moving_to_BURNIN") < answer.indexOf("moving_to_BURNOUT"));
			assertTrue(answer.indexOf("moving_to_BURNOUT") < answer.indexOf("moving_to_ASHOUT"));
