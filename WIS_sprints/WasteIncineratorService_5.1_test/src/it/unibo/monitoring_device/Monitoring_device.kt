		...
		return { //this:ActionBasciFsm
				...
				state("handleEnd") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t043",targetState="handleSonar",cond=whenDispatch("sonar_value"))
					transition(edgeName="t044",targetState="handleStart",cond=whenDispatch("burn_start"))
					transition(edgeName="t045",targetState="handleEnd",cond=whenDispatch("burn_end"))
				}	 
				state("handleSonar") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t046",targetState="handleSonar",cond=whenDispatch("sonar_value"))
					transition(edgeName="t047",targetState="handleStart",cond=whenDispatch("burn_start"))
					transition(edgeName="t048",targetState="handleEnd",cond=whenDispatch("burn_end"))
				}	 
			}
		}
} 
