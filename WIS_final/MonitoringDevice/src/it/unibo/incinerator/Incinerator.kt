		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t133",targetState="activated",cond=whenDispatch("activation_command"))
				}	 
				...
				state("ready") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t134",targetState="burning",cond=whenDispatch("burn_start"))
				}	 
				state("burning") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t135",targetState="ready",cond=whenDispatch("ash_taken"))
				}	 
			}
		}
} 
